...
only of two modules with correspondent languages $L_1$ and $L_2$, i.e. the
language of the system is $L = L_1 \parallel L_2$. Suppose that only one module
has a faulty behaviour, i.e $L_1 = L_{1,f} ~\dot{\cup}~ L_{1,nf}$. Suppose that
$L_1$ is not locally diagnosable, but $L$ is diagnosable.

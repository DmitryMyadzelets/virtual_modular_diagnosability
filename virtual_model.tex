%  Submission details: http://www.ecc14.eu/call-for-papers.html 
% \documentclass[a4paper,oneside]{article} \documentclass[a4paper, 10pt,
% conference]{ieeeconf}
...
\usepackage[pdftex, pdftitle={Virtual Modules in Discrete-Event Systems:
Achieving Modular Diagnosability}, pdfauthor={Dmitry Myadzelets},
bookmarks=false,
...
a diagnosability approach can be \emph{centralized},
...
property. We study how to choose the system's modules for the composition. For
this goal a structural analysis of the system is introduced. 

We refer to \cite{ye_optimized_2010} as to one of the recent works addressing
...
\ref{sec:Conclusion} concludes the current results and discusses possible
...
have a heuristic procedure to choose which module to pick to verify
diagnosability.

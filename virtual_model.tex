...
\end{subequations}
$$
	\textrm{where } M_{\backslash 1}: \Sigma^* \rightarrow (\Sigma_{o} \backslash
	\Sigma_1)^*.
	\\[1em]
$$
\end{lemma}
...
$M_{\backslash 1}(t') = \emptyset$, and then $M_{\backslash 1}(P_2(t')) =
...
$M_{\backslash 1}(t) = \emptyset$. Then may $\exists t'\sigma \in 
L \subseteq P_2^{-1}(t\sigma)$ such that $M_{\backslash 1}(t') =
...
\begin{align}
	...
	[M_{\backslash 1}(t\backslash t'\sigma) \neq \emptyset]
	\label{lem:dist3}
\end{align}
\end{subequations}
...
$M_{\backslash 1}(t) = M_{\backslash 1}(w)$. And may $\exists t'' \in
\overline{t}$ such that $M_{\backslash 1}(t'') = M_{\backslash 1}(w)$.  Since

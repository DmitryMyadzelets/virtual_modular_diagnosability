...
Informally, the above lemma implies blocking of the occurence of observable
events from the observable support of $s$ in all the strings of the
global language which are projected to $L_1\backslash s$. Then, whenever we
observe these events we are sure they occure in the prefix of $s$.
